...
import { SUBCATEGORIES_STAVEBNINY } from '../../pages/data'
...
export const Mrizka: Story = { render: () => <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 2 }}>{SUBCATEGORIES_STAVEBNINY.map((c) => <CategoryTile key={c} title={c} size="small" />)}</Box> }
